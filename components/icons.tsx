...
export const Icons = {
  ...
  firecracker: (props: LucideProps) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" fill="none" {...props}>
      {/* Circular, modern firecracker logo */}
      <circle cx="16" cy="16" r="12" fill="currentColor" fillOpacity="0.18" />
      <circle cx="16" cy="16" r="7" fill="currentColor" fillOpacity="0.5" />
      <ellipse cx="16" cy="20" rx="4" ry="7" fill="#fbbf24" fillOpacity="0.85" />
      <ellipse cx="16" cy="20" rx="2.2" ry="4.5" fill="currentColor" fillOpacity="0.9" />
